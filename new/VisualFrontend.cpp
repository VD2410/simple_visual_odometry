...
void VisualFrontend::newpoints(const GpuMat& d_mat, vector<Point2f>& vec)
{
...
void VisualFrontend::newmasks(const GpuMat& d_mat, vector<uchar>& vec)
{
	vec.resize(d_mat.cols);
...
void VisualFrontend::extract1(Mat& im_gray, Features2D& newPoints)
{
    ...
    newpoints(d_prevPts, newPointsVector);
